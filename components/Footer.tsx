        ...
        <div className="footer__grid">
          <div className="footer__brand">
            ...
            <div className="social-strip">
              <a href="https://discord.gg/rXBZkSPcJb" className="social-link" target="_blank" rel="noopener" aria-label="Discord">
                {/* Discord */}
              ...
              <a href="https://www.instagram.com/edthestatman" className="social-link" target="_blank" rel="noopener" aria-label="Instagram">
