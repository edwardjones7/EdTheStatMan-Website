        ...
        <div className="container">
          ...
          <div className="reveal-scale" style={{ marginTop: '32px', maxWidth: '640px', marginLeft: 'auto', marginRight: 'auto' }}>
            <p style={{ color: 'var(--text-secondary)', lineHeight: '1.8', marginBottom: '16px' }}>
              <strong style={{ color: 'var(--text-primary)' }}>Email:</strong> We typically respond within 24–48 hours during business days. For urgent matters, consider reaching out via X or Discord for faster response times.
            </p>
            <p style={{ color: 'var(--text-secondary)', lineHeight: '1.8', marginBottom: '16px' }}>
              <strong style={{ color: 'var(--text-primary)' }}>X &amp; Discord:</strong> Our community channels are monitored regularly. For quick questions about picks, systems, or memberships, following us on X or joining Discord is often the fastest way to get answers.
            </p>
